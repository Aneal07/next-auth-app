...
const page = () => {
  ...
  <div className='bg-white p-6 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-6'>
    <div>
      ...
      <p className='text-gray-700 mb-4'>
        The front-end of the application is built with Next.js and uses Clerk
        for user authentication. The back-end is connected to MongoDB using
        Mongoose.
      </p>
      <p className='text-gray-700 mb-4'>
        This application is intended as a starting point for building full-stack
        web applications with authentication using Next.js, Clerk, and Mongoose.
      ...
      <ul className='text-gray-700 mb-4 space-y-2'>
        <li>
          <a
            href='https://github.com/Aneal07/next-auth-app'
            target='_blank'
